...
const Register = () => {
    ...
    const handelRegister = (e) => {
        ...
        const NewUserData = {...otherData , email}
                ...
                >
                    <div className='h-full flex flex-col justify-center items-center text-center'>
                        ...
                        <p className="py-6 lg:text-[19px] md:text-[13px] text-base-100">
                            Make your free account now and find All your essential Books!
                        </p>
                    </div>
                </div>
                    ...
                    <div className="card w-full ">
                        <div className="card-body">
                            ...
                            <form onSubmit={handelRegister} className="fieldset">
                                ...
                                <p>Already have an account? Click here to <span className='text-sky-400 text-[14px]'> <Link to={'/login'}>Login.</Link></span> </p>
